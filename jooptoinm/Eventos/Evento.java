...
public abstract class Evento implements RelatorioReceita {
    ...
    public void exibirExtrato(){
        ...
        System.out.printf("Total de Ingresssos disponíveis: %d\n", quant_ingressos - ingressosVendidos);
    ...
    public void venderIngresso(int quantidade, String tipo_ingresso) {
        if (verificarDisponibilidade(quantidade, tipo_ingresso)) {  // Verificando se essa quantidade de ingressos de um tipo específico, está disponível
            ...
            if(tipo_ingresso.equals("Normal")){  // Caso seja normal, será acumulado em um contador para o cálculo final de ingressos Normais
                ingressosNormaisVendidos += quantidade;
            } else if (tipo_ingresso.equals("VIP")) {  // Caso seja VIP, será acumulado em um contador para o cálculo final de ingressos VIP
                ingressosVipVendidos += quantidade;
            } else if (tipo_ingresso.equals("Meia-Entrada")) {  // Caso seja meia, será acumulado em um contador para o cálculo final de ingressos Meia
